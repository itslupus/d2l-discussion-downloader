<?php
    ...
    if ($DEBUG) {
        ...
        curl_setopt($curl, CURLOPT_POST, true);
        curl_setopt($curl, CURLOPT_POSTFIELDS, 'gridPartialInfo$_type=D2L.LP.Web.UI.Desktop.Controls.GridPartialArgs&gridPartialInfo$SortingInfo$SortField=OrgUnitName&gridPartialInfo$SortingInfo$SortDirection=0&gridPartialInfo$NumericPagingInfo$PageNumber=1&gridPartialInfo$NumericPagingInfo$PageSize=10&searchTerm=&status=-1&toStartDate$Year=2019&toStartDate$Month=11&toStartDate$Day=29&toStartDate$Hour=21&toStartDate$Minute=0&toStartDate$Second=0&fromStartDate$Year=2019&fromStartDate$Month=11&fromStartDate$Day=29&fromStartDate$Hour=21&fromStartDate$Minute=0&fromStartDate$Second=0&toEndDate$Year=2019&toEndDate$Month=11&toEndDate$Day=29&toEndDate$Hour=21&toEndDate$Minute=0&toEndDate$Second=0&fromEndDate$Year=2019&fromEndDate$Month=11&fromEndDate$Day=29&fromEndDate$Hour=21&fromEndDate$Minute=0&fromEndDate$Second=0&hasToStartDate=False&hasFromStartDate=False&hasToEndDate=False&hasFromEndDate=true&filtersFormId$Value=' . $id . '&_d2l_prc$headingLevel=2&_d2l_prc$scope&_d2l_prc$childScopeCounters=filtersData:0;FromStartDate:0;ToStartDate:0;FromEndDate:0;ToEndDate:0&_d2l_prc$hasActiveForm=false&filtersData$semesterId=All&filtersData$departmentId=All&isXhr=true&requestId=4&d2l_referrer=' . $token);
